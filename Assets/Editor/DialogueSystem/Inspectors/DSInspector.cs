...
namespace DS.Inspectors
{
    ...
    public class DSInspector : Editor
    {
        ...
        private void StopDrawing(string reason, MessageType messageType = MessageType.Info)
        {
            ...
            DSInspectorUtility.DrawHelpBox("You need to select a Dialogue for this component for this component to work at Runtime!", MessageType.Warning);
        ...
        private void UpdateIndexOnNamesListUpdate(List<string> optionNames, SerializedProperty indexProperty, int oldSelectedPropertyIndex, string oldPropertyName, bool isOldPropretyNull)
        {
            if (isOldPropretyNull)
            {
            ...
            bool oldNameIsDifferentThanSelectedNames = oldIndexIsOutOfBoundsOfNamesListCount || oldPropertyName != optionNames[oldSelectedPropertyIndex];

            if (oldNameIsDifferentThanSelectedNames)
            {
